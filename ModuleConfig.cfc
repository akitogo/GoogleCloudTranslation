...
component {
	...
	// Module Properties
	this.title 				= "GoogleCloudTranslation";
	this.author 			= "Aktiogo Team";
	this.webURL 			= "www.akitogo.com";
	this.description 		= "Implements Google Cloud Translation Api";
	this.version			= "1.0.0";
	...
	// Module Entry Point
	this.entryPoint			= "GoogleCloudTranslation";
	// Model Namespace
	this.modelNamespace		= "GoogleCloudTranslation";
	// CF Mapping
	this.cfmapping			= "GoogleCloudTranslation";
	// Auto-map models
